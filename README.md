...
### Task 4 — Medium: `NFTMint` (3 vulnerabilities)
- **Contract**: NFT minting contract with whitelist and 1000 max supply
- **Vulns**: Weak randomness via `block.timestamp`, front-running in whitelist mint, locked ETH with no withdrawal
- **Challenge**: Find all 3 including the subtle locked ETH issue

### Task 5 — Hard: `VulnToken` ERC-20 (4 vulnerabilities)
...
| task4 | NFTMint | 3 | Medium | ~0.58 |
| task5 | VulnToken | 4 | Hard | ~0.38 |
